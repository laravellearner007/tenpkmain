                ...
                <div class="content-side col-lg-9 col-md-12 col-sm-12">
                    <div class="our-courses">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="pull-right clearfix">
                                    ...
                                    <ul class="list-view">
                                        ...
                                        <li class="active"><a href="course-list.html"><span
                        ...
                        <div class="cource-block-three">
                            <div class="inner-box">
                                <div class="image">
                                    <a href="course-detail.html"><img src="https://via.placeholder.com/270x250"
                                            alt="" /></a>
                                </div>
                                <div class="content-box">
                                    <div class="box-inner">
                                        <h5><a href="course-detail.html">Ultimate User Interface and user Experince
                                                Courses</a></h5>
                                        <div class="text">Replenish him third creature and meat blessed void a fruit
                                            gathered you’re, they’re two waters. Replenish him third creature and meat
                                            blessed void a fruit gathered two waters.</div>
                                        <div class="clearfix">
                                            <div class="pull-left">
                                                <div class="level-box">
        ...
        <div class="auto-container">
            ...
            <div class="cource-block-four">
                <div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <div class="content-box">
                        <div class="box-inner">
                            <h5><a href="course-detail.html">Ultimate User Interface and user Experince Courses</a></h5>
                            <div class="text">Replenish him third creature and meat blessed void a fruit gathered you’re,
                                they’re two waters. Replenish him third creature and meat blessed void a fruit gathered
                                you’re, they’re two waters.</div>
                            <div class="clearfix">
                                <div class="pull-left">
                                    <div class="level-box">
                                        <span class="icon flaticon-settings-1"></span>

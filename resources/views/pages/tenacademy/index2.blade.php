...
@section('content')
    <!-- Slider Section -->
    <section class="slider-section" style="background-image: url(images/main-slider/1.png)">
                        ...
                        <div class="content-column col-lg-6 col-md-12 col-sm-12">
                            <div class="inner-column">
                                ...
                                <div class="text">There are many variations of passages of Lorem Ipsum available, but the
                                    majority have suffered alteration in some form by injected humour or randomisedable.
                                </div>
                                <div class="btns-box">
                                    <a href="course.html" class="theme-btn btn-style-four"><span class="txt">Get Stared
                                            <i class="fa fa-angle-right"></i></span></a>
                                    <a href="course.html" class="theme-btn btn-style-five"><span class="txt">All Courses
                                            <i class="fa fa-angle-right"></i></span></a>
                                </div>
                            </div>
                        </div>
    ...
    {{-- <section class="education-section-two">
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="image-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="image titlt" data-tilt data-tilt-max="4">
							<a href="https://via.placeholder.com/607x597" data-fancybox="education" data-caption="" class=""><img src="https://via.placeholder.com/607x597" alt="" /></a>
						</div>
					</div>
				</div>
    ...
    {{-- <section class="institution-section">
		<div class="auto-container">
			...
			<div class="row clearfix">
				...
				<!-- Institution Block -->
				<div class="institution-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<a href="course.html" class="theme-btn btn-style-seven"><span class="txt">Enroll Now</span></a>
					</div>
				</div>
				...
				<div class="institution-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h4><a href="course.html">Mechanical Engineering</a></h4>
						<div class="text">Replenish him third creature and meat of the blessed void a fruit</div>
						<div class="price">$140</div>
						<a href="course.html" class="theme-btn btn-style-seven"><span class="txt">Enroll Now</span></a>
					</div>
				...
				<div class="institution-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h4><a href="course.html">Business Studies</a></h4>
						<div class="text">Replenish him third creature and meat of the blessed void a fruit</div>
						<div class="price">$140</div>
						<a href="course.html" class="theme-btn btn-style-seven"><span class="txt">Enroll Now</span></a>
					</div>
				...
				<div class="institution-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h4><a href="course.html">Architecture</a></h4>
						<div class="text">Replenish him third creature and meat of the blessed void a fruit</div>
						<div class="price">$140</div>
						<a href="course.html" class="theme-btn btn-style-seven"><span class="txt">Enroll Now</span></a>
					</div>
				...
				<div class="institution-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h4><a href="course.html">Accounting</a></h4>
						<div class="text">Replenish him third creature and meat of the blessed void a fruit</div>
						<div class="price">$140</div>
						<a href="course.html" class="theme-btn btn-style-seven"><span class="txt">Enroll Now</span></a>
					</div>
				...
				<!-- Institution Block -->
				<div class="institution-block empty-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						<a href="course.html" class="theme-btn btn-style-six"><span class="txt">Browse All</span></a>
					</div>
				</div>
    ...
    {{-- <section class="program-section">
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="content-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<h2>Why choose us? <br> Discover your perfect program in <br> our online schools</h2>
						<div class="text">
				...
				<div class="image-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="image titlt" data-tilt data-tilt-max="4">
							<a href="https://via.placeholder.com/557x598" data-fancybox="program" data-caption="" class=""><img src="https://via.placeholder.com/557x598" alt="" /></a>
						</div>
					</div>
				</div>
			...
			<div class="row clearfix">
				...
				<div class="event-block-two col-lg-6 col-md-12 col-sm-12">
					<div class="inner-box">
						...
						<h4><a href="course-detail.html">Workshop on UX/UI (How people see & how <br> people remember)</a></h4>
						<div class="text">Replenish him third creature and of the meat of the <br> blessed void a fruit</div>
					</div>
				</div>
				...
				<div class="event-block-two col-lg-6 col-md-12 col-sm-12">
					<div class="inner-box">
						<div class="clearfix">
							<!-- Event Date -->
							<div class="event-date clearfix"><span class="date">23</span>Jan 2020</div>
							<!-- Event List -->
							<ul class="event-list">
								<li><a href="course-detail.html">ART & DESIGN</a></li>
								<li><a href="course-detail.html">PAINTING</a></li>
						...
						<div class="content">
							<div class="row clearfix">
								...
								<div class="price-block col-lg-4 col-md-6 col-sm-12">
									<div class="inner-box">
										<div class="icon-box">
											<span class="icon"><img src="https://via.placeholder.com/285x130" alt="" /></span>
										</div>
										<h3>Basic</h3>

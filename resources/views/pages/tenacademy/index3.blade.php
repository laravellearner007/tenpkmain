...
@section('content')
				...
				<div class="auto-container">
					<div class="row clearfix">
						...
						<div class="image-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<div class="image">
									<img src="https://via.placeholder.com/743x634" alt="" />
								</div>
							</div>
						</div>
	...
	<section class="title-section">
		<div class="pattern-layer" style="background-image:url(images/icons/icon-4.png)"></div>
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="image-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="image titlt" data-tilt data-tilt-max="4">
							<a href="images/resource/education-2.png" data-fancybox="education-2" data-caption="" class=""><img src="https://via.placeholder.com/470x600" alt="" /></a>
						</div>
					</div>
				</div>
    ...
    <section class="project-section">
		<!-- Pattern Layer -->
		<div class="pattern-layer" style="background-image:url(images/icons/icon-5.png)"></div>
		<div class="pattern-layer-two" style="background-image:url(images/icons/dotted-layer-1.png)"></div>
    	<div class="auto-container">
                    ...
                    <div class="p-tab active-tab" id="p-tab-1">
                        <div class="project-carousel owl-theme owl-carousel">
							...
							<div class="institute-block-two">
								<div class="inner-box">
									<div class="image">
										<a href="books-detail.html"><img src="https://via.placeholder.com/386x235" alt="" /></a>
									</div>
				...
				<div class="image-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="image titlt" data-tilt data-tilt-max="2">
							<a href="images/resource/education-3.png" data-fancybox="education-2" data-caption="" class=""><img src="https://via.placeholder.com/470x600" alt="" /></a>
						</div>
					</div>
				</div>
	...
	<section class="achievements-section-three">
		<!-- Pattern Layer -->
		<div class="pattern-layer" style="background-image:url(images/icons/dotted-layer-2.png)"></div>
	...
	<section class="testimonial-section-two">
		<!-- Pattern Layer -->
		<div class="pattern-layer" style="background-image:url(images/icons/dotted-layer-3.png)"></div>
		<div class="pattern-layer-two" style="background-image:url(images/icons/icon-5.png)"></div>
		<div class="auto-container">
			<!-- Sec Title -->
			<div class="sec-title style-two centered">
